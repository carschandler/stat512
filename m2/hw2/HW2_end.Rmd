...
Conduct screening through the scatter plot, residual plot on 𝑋, residual plot on 𝑌෠, Shapiro test, BrownForsythe test, Breusch-Pagan test, and provide comments on:
• Linear relationship
• Constant variance
• Normal errors
• Outliers 
